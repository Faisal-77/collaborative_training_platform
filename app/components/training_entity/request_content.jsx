    ...
    <>
      ...
      >
        <div className={`col-12`}>
          ...
          >
            <path
              d="M21.2352 11.3901L14.622 12.1005L14.3852 13.0428L15.6875 13.2458C16.5332 13.4198 16.7024 13.6807 16.5163 14.4056L14.3852 22.9881C13.827 25.2062 14.6896 26.25 16.7193 26.25C18.2922 26.25 20.1189 25.6266 20.9477 24.7713L21.2014 23.7419C20.6263 24.1769 19.7806 24.3508 19.2225 24.3508C18.4275 24.3508 18.14 23.8724 18.343 23.0316L21.2352 11.3901Z"
              fill="white"
            />
            <path
              d="M21.4352 6.22423C21.4352 7.5907 20.1429 8.69845 18.5486 8.69845C16.9544 8.69845 15.662 7.5907 15.662 6.22423C15.662 4.85775 16.9544 3.75 18.5486 3.75C20.1429 3.75 21.4352 4.85775 21.4352 6.22423Z"
              fill="white"
            />
          </svg>
          <span
            className={`${styles.text_req_span_content_state} text-center 
                    ${
                      state == "مقبول"
                        ? styles.req_state_accepted
                        : state == "مرفوض"
                        ? styles.req_state_rejected
          ...
          <div className={styles.chatBox}>
            <div className={styles.contentContact}>
              ...
              {state == "مقبول" ? (
                ...
                <Rejected spp={spp} date_of_rejected={date_of_rejected} />
              ) : (
  ...
  return (
    <div>
      ...
      <h5 className="text-center mt-2">
        {" "}
        سيتم إشعارك عند الانتهاء من كافة الإجراءات{" "}
      </h5>
    </div>
  );
}
